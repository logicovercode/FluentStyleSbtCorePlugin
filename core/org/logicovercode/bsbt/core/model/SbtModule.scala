...
case class SbtModule private[SbtModule](moduleID: ModuleID,
  ...
  def sourceCode : SbtModule = SbtModule(moduleID, optionalProjectRef, optionalModuleSource, true)
...
object SbtModule{
  ...
  def apply(moduleID: ModuleID, sbtModulePath : String, sbtModuleName : String) : SbtModule = {
