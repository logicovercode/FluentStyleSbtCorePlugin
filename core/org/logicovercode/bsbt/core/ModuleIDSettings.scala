...
trait ModuleIDSettings {
  ...
  implicit def moduleIdToSeqJvmModuleID(moduleID: ModuleID): Seq[JvmModuleID] = {
    val jvmModuleID = JvmModuleID(moduleID)
    Seq(jvmModuleID)
  }

  implicit def jvmModuleIdToSeqJvmModuleID(jvmModuleID: JvmModuleID): Seq[JvmModuleID] = {
    Seq(jvmModuleID)
  }
  ...
  //val SimpleSbtBuild = org.logicwithcode.builder_style_sbt_build.core.model.ModuleBuild
  //type SimpleSbtBuild = org.logicwithcode.builder_style_sbt_build.core.model.ModuleBuild
}